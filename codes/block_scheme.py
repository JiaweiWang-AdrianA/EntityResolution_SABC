    ...
    if dataset:
        for product_id, profile in sorted(dataset.items(), key=lambda x: x[0]):
            if source_type == "t":  # title
                ...
                temblocks = Transfer(Text_Tokenizer(
                    title, tokenizer), transfer)
                ...
                temblocks = Transfer(Text_Tokenizer(
                    description, tokenizer), transfer)
...
# block_scheme1 = {'1':'id1,id2','2':'id2,id3,id4'}
# block_scheme2 = {'1':'id1,id3','2':'id4,id5'}
# res = Aggregator('x', block_scheme1, block_scheme2)
# print(res)
